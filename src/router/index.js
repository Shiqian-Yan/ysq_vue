...
export const constantRoutes = [
  ...
  // 首页
  {
    ...
    children: [{
      ...
      meta: { title: '博客系统后台首页', icon: 'dashboard' }
    }]
  }]
/**
 * 动态路由
...
export const asyncRoutes = [
...

  {
    ...
    name: '博客分类',
    meta: { title: '博客分类', icon: 'example' },
    children: [
      {
        path: 'list',
        name: '博客分类列表',
        component: () => import('@/views/myblog/class/list'),
        meta: { title: '博客分类列表', icon: 'table' }
      },
      {
        path: 'save',
        name: '导入博客分类',
    ...
    children: [
      {
        path: 'addmainpage',
        name: '修改主页',
        component: () => import('@/views/banner/mainpage/add'),
        meta: { title: '修改主页', icon: 'table' }
      },
      ,
      {
        path: 'update',
